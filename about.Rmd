...
**Hospital for Special Surgery, Data Research Intern**     
 ...
 ▪ Quantified [team consistency score](Investigate the role of team consistency score in patients’ surgery outcome.pdf) for each spinal surgery based on survey data collected from surgeons, anesthetists as well as assistants and transferred into a continuous variable in building HAI prediction models   
...
### Research Experience  
**Survival Disparities in patients diagnosed with colorectal cancer, [Mediation Analysis Project](mediation.html)**     
▪ Identify demographic determinants of survival disparities in patients diagnosed with colorectal cancer  
▪ Investigate the variability in treatment waiting time in patient population and quantify its contribution to the survival disparities while adjusting for other confounders
▪ Employed both parametric methods (Accelerated Failure Time) and Semi-parametric methods (Proportional Hazards Model) to quantify the mediation effect of surgery waiting time on survival disparities  
▪ Developed the framework to conduct mediation analysis for censored data in the clinical practice  
